...
description: Normalize, align, and frame a product backlog for prioritization. Invoke when you have a list of backlog items and need to rank them by strategic leverage.
---
