...
> **This is a reference example.** It shows what a finished discovery brief looks like for a SentinelOne PM.
> Use it to calibrate your own output. The data is illustrative — not from a real Jira session.

---

**Product Line:** Purple AI
**PM:** Sarah Chen
**Date:** March 2026
...
|------|----------|-------|-------|---------------|--------------|-----|-----------|
| 1 | FSR-2841 | Auto-triage low-confidence alerts with Purple AI | 24 | $890K | $1,200K | 4 months | ✅ Current |
| 2 | FSR-1992 | Build custom dashboards from Purple AI investigation data | 18 | $1,100K | $800K | 7 months | ✅ Current |
...
| 9 | FSR-2902 | Scheduled Purple AI threat hunt reports | 9 | $670K | $400K | 6 months | ✅ Current |
| 10 | FSR-3210 | Purple AI explain mode for junior analysts | 8 | $380K | $250K | 2 months | ✅ Current |
...
**Why:**
- **OKR alignment:** Directly moves two Q1 OKRs — MTTI reduction (auto-triage eliminates analyst time on low-confidence alerts) and Purple AI adoption (a top friction point cited in onboarding interviews)
...
**Suggested PRD framing:** "How can Purple AI reduce the time SOC analysts spend on low-confidence alerts by automatically triaging, contextualizing, and routing them — without requiring analyst review for each one?"
...
- Healthy request count for Purple AI: ~80–120 open requests (this session: 94 — healthy)
