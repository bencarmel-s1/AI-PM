...
Claude doesn't remember anything between sessions by default. But you can give it persistent context by creating a `CLAUDE.md` file in your working folder. See `getting-started/claude-md-setup.md` for how to set this up.
