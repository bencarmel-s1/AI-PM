...
```
Use @agents/engineer.md to review @prd-v2.md before I share it with engineering
```

```
Use @agents/engineer.md to give me a rough complexity assessment of the features in @roadmap-candidates.md
```

```
Use @agents/engineer.md to flag edge cases and missing states in @feature-spec.md
```
