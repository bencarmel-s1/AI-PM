...
> **Don't have a company context file yet? Start with `5-Knowledge/Reference/product.md` — add your product's pillars, key metrics, and team context. Then reference it here.
...
For a ready-to-fill template, see `5-Knowledge/Reference/product.md` and adapt it for your team.
