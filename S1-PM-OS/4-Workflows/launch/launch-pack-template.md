...
Context: @company-context-example.md
Feature name: [feature name]
Launch tier: [Major / Minor / Patch]
```

Claude will fill in every section below using your PRD and sprint context.
See `example-launch-pack.md` for a fully worked example (Pulse Anomaly Detection).
...
**Version:** [vX.X]
**Release date:** [date]
**Platform area:** [Your product area or feature name]
...
- [Impact 3 — e.g., "Directly supports the Alerts adoption OKR by reducing setup friction"]
